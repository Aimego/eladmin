    ...
    <div class="role">
      <div class="header-contain">
        <el-form inline :model="query" ref="filter-form">
          <el-form-item prop="name">
              <el-input v-model="query.username" placeholder="请输入用户名称" size="small"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <div class="body-contain">
          ...
          >
            ...
            >
              <template slot-scope="scope">
                <el-button size="small" type="primary" icon="el-icon-edit" @click="editUesr(scope.row)"></el-button>
         ...
         <el-dialog 
            ...
            width="30%"
            >
            <el-form :model="form" :inline="true" :rules="ruleForm" ref="roleForm" label-width="66px">
              <el-form-item label="用户名" prop="username">
                <el-input v-model="form.username" size="small" placeholder="请输入用户名"></el-input>
              </el-form-item>
              <el-form-item label="电话" prop="phone">
                <el-input v-model="form.phone" size="small" placeholder="请输入用户电话"></el-input>
              </el-form-item>
              <el-form-item label="昵称" prop="name">
                <el-input v-model="form.name" size="small" placeholder="请输入用户昵称"></el-input>
              </el-form-item>
              <el-form-item label="邮箱" prop="email">
                <el-input v-model="form.email" size="small" placeholder="请输入用户邮箱"></el-input>
              </el-form-item>
