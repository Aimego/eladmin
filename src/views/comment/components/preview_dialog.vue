    ...
    >
      ...
      <el-form ref="form" :model="form" label-width="120px">
        ...
        <el-form-item label="评论内容：">
          <el-input v-model="form.evaluate" type="textarea" disabled />
        </el-form-item>

        <el-form-item label="实验内容评分：">
          <el-rate v-model="form.excontent" disabled :colors="colors" show-score text-color="#ff9900" />
        </el-form-item>

        <el-form-item label="操作系统评分：">
          <el-rate v-model="form.opsystem" disabled :colors="colors" show-score text-color="#ff9900" />
        </el-form-item>

        <el-form-item label="支持服务评分：">
          <el-rate v-model="form.spservices" disabled :colors="colors" show-score text-color="#ff9900" />
        </el-form-item>
